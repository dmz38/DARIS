...
<div class="col-sm-10">
    ...
    <div class="row">
        <h6><span class="guardianText">PARENT'S</span><span class="selfText">YOUR</span> INFORMATION </h6>
        <b>
            <hr>
        </b>
        ...
        <div class="searchCriteria">
            ...
            <div>
                <button id="part4Prev" class="btn btn-primary target pull-left prev" type="submit">BACK</button>
                <button id="part4Next" class="btn btn-primary target pull-right" type="submit">NEXT</button>
            </div>
        </div>
    </div>
</div>
