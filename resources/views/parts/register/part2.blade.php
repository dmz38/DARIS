...
<div class="col-xs-10">
    ...
    <br>
    <div>
        <button id="part2Prev" class="btn btn-primary target pull-left prev" type="button">BACK</button>
        <button id="part2Next" class="btn btn-primary target pull-right" type="button">NEXT</button>
    </div>
</div>
<div class="col-xs-1">&nbsp;</div>